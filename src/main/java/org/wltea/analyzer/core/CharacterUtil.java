...
class CharacterUtil {
    ...
    public static final int CHAR_OTHER_CJK_SYMBOL = 0X00000007;
     ...
     */
    static int identifyCharType(char input, Configuration cfg) {
        if (input >= '0' && input <= '9') {
            return CHAR_ARABIC;
            ...
            if (cfg.isUseSingleSegmenter()) {
                return CHAR_OTHER_CJK_SYMBOL;
            }
        }
        // 其他的不做处理的字符
        return CHAR_USELESS;
