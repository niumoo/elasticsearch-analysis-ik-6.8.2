...
public class TestIk {
    ...
    @Test
    public void useSingleSegmenterCleanSpace() throws Exception {
        String text = "中华abc人民共￥和1231国的Hello WORld java";
        Configuration configuration = new Configuration(false);
        configuration.setUseSingleSegmenter(true);
    ...
    public void println(Configuration configuration, String text) throws IOException {
        // 创建分词对象
